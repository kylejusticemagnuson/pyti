...
class TestTripleExponentialMovingAverage(unittest.TestCase):
    ...
    def test_triple_exponential_moving_average_period_6(self):
        period = 6
        tema = triple_exponential_moving_average.triple_exponential_moving_average(
            self.data, period)
