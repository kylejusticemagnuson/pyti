...
class TestChandeMomentumOscillator(unittest.TestCase):
    ...
    def test_cmo_period_6(self):
        period = 6
        cmo = chande_momentum_oscillator.chande_momentum_oscillator(
