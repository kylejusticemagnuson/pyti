...
class TestAverageTrueRangePercent(unittest.TestCase):
    ...
    def test_atrp_period_6(self):
        period = 6
        atrp = average_true_range_percent.average_true_range_percent(
            self.close_data, period)
    ...
    def test_atrp_invalid_period(self):
        ...
        with self.assertRaises(Exception) as cm:
            average_true_range_percent.average_true_range_percent(
                self.close_data, period)
