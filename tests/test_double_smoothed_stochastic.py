...
class TestDoubleSmoothedStochastic(unittest.TestCase):
    ...
    def test_double_smoothed_stochastic_period_6(self):
        period = 6
        dss = double_smoothed_stochastic.double_smoothed_stochastic(
            self.data, period)
    ...
    def test_dss_invalid_period(self):
        ...
        with self.assertRaises(Exception) as cm:
            double_smoothed_stochastic.double_smoothed_stochastic(
                self.data, period)
