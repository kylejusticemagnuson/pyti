...
class TestMovingAverageEnvelope(unittest.TestCase):
    ...
    def test_upper_band_period_6(self):
        period = 6
        env_percentage = 0.1
        ub = moving_average_envelope.upper_band(self.data, period,
                                                env_percentage)
    ...
    def test_upper_band_invalid_period(self):
        ...
        env_percentage = 0.1
        with self.assertRaises(Exception) as cm:
            moving_average_envelope.upper_band(self.data, period,
                                               env_percentage)
        expected = "Error: data_len < period"
        self.assertEqual(str(cm.exception), expected)
    ...
    def test_lower_band_period_6(self):
        period = 6
        env_percentage = 0.1
        lb = moving_average_envelope.lower_band(self.data, period,
                                                env_percentage)
    ...
    def test_lower_band_invalid_period(self):
        ...
        env_percentage = 0.1
        with self.assertRaises(Exception) as cm:
            moving_average_envelope.lower_band(self.data, period,
                                               env_percentage)
        expected = "Error: data_len < period"
        self.assertEqual(str(cm.exception), expected)
