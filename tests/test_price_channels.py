...
from pyti import price_channels
...
class TestPriceChannels(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.upc_period_6_upper_percent_6_expected = [
            np.nan,
            np.nan,
            np.nan,
            np.nan,
        ...
        self.upc_period_8_upper_percent_3_expected = [
            np.nan,
            np.nan,
            np.nan,
            np.nan,
        ...
        self.lpc_period_6_lower_percent_6_expected = [
            np.nan,
            np.nan,
            np.nan,
            np.nan,
        ...
        self.lpc_period_8_lower_percent_3_expected = [
            np.nan,
            np.nan,
            np.nan,
            np.nan,
    ...
    def test_upc_period_6_upper_percent_6(self):
        ...
        np.testing.assert_array_equal(
            upc, self.upc_period_6_upper_percent_6_expected)
    ...
    def test_lpc_period_6_lower_percent_6(self):
        ...
        lpc = price_channels.lower_price_channel(self.data, period,
                                                 lower_percent)
        np.testing.assert_array_equal(
            lpc, self.lpc_period_6_lower_percent_6_expected)
