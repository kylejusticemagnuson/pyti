...
class TestStandardVariance(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.macd_period_6_period_12_expected = [
            np.nan,
            np.nan,
            np.nan,
            np.nan,
        ...
        self.macd_period_8_period_16_expected = [
            np.nan,
            np.nan,
            np.nan,
            np.nan,
            ...
            -2.6144957833257649,
            -1.4859449539270599,
            0.0015168731961239246,
            -0.028984050351709811,
            1.3049033428892471,
            2.2332244651028077,
            1.5753673669764794,
            0.47932110877866307,
    ...
    def test_macd_period_6_period_12(self):
        ...
        macd = (moving_average_convergence_divergence.
                moving_average_convergence_divergence(self.data, short_period,
                                                      long_period))
