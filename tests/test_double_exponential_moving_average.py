...
class TestDoubleExponentialMovingAverage(unittest.TestCase):
    ...
    def test_double_exponential_moving_average_period_6(self):
        period = 6
        dema = double_exponential_moving_average.double_exponential_moving_average(
            self.data, period)
