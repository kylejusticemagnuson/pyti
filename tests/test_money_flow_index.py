...
class TestMoneyFlow(unittest.TestCase):
    ...
    def test_money_flow_index_period_6(self):
        period = 6
        mfi = money_flow_index.money_flow_index(self.close_data, self.high_data,
    ...
    def test_money_flow_index_invalid_period(self):
        ...
        with self.assertRaises(Exception) as cm:
            money_flow_index.money_flow_index(self.close_data, self.high_data,
                                              self.low_data, self.volume,
                                              period)
